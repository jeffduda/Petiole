/*=========================================================================
  ...
  Module:    $RCSfile: itkGraphTopologicalOverlapCalculatorTest.cxx,v $
  Language:  C++
  Date:      $Date: $
  Version:   $Revision: $
...
int itkGraphTopologicalOverlapCalculatorTest( int itkNotUsed(argc), char * itkNotUsed(argv) [] )
{
  ...
  typedef itk::GraphTopologicalOverlapCalculator<GraphType>      CalculatorType;
  ...
  calc->Compute();
  CalculatorType::MatrixType overlap = calc->GetTopologicalOverlap();
  std::cout << "Adjacency matrix (m=0)" << std::endl;
  std::cout << overlap << std::endl;

  calc->SetDegree( 2  );
  calc->Compute();
  overlap = calc->GetTopologicalOverlap();
  std::cout << "Topological overlap (m=2)" << std::endl;
  std::cout << overlap << std::endl;
