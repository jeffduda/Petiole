/*=========================================================================
  ...
  Module:    $RCSfile: itkExtractKCoreGraphFilterTest.cxx,v $
  Language:  C++
  Date:      $Date: $
  Version:   $Revision: $
...
int itkExtractKCoreGraphFilterTest( int itkNotUsed(argc), char * itkNotUsed(argv) [] )
{
  ...
  typedef itk::ExtractKCoreGraphFilter<GraphType,GraphType>    FilterType;
