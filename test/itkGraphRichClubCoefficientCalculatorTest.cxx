...
int itkGraphRichClubCoefficientCalculatorTest( int itkNotUsed(argc), char * itkNotUsed(argv) [] )
{
  ...
  std::cout << "As directed binary graph" << std::endl;
  graph->SetIsDirected( true );
  calc->SetLevel( 1 );
  calc->ComputeUnweighted();
  std::cout << "k=1: " << calc->GetRichClubCoefficient() << std::endl;
  calc->SetLevel( 2 );
  calc->ComputeUnweighted();
  std::cout << "k=2: " << calc->GetRichClubCoefficient() << std::endl;
  calc->SetLevel( 3 );
  calc->ComputeUnweighted();
  std::cout << "k=3: " << calc->GetRichClubCoefficient() << std::endl; 

  std::cout << std::endl << "As undirected binary graph" << std::endl;
  ...
  std::cout << std::endl << "As directed weighted graph" << std::endl;
  graph->SetIsDirected( true );
  calc->SetLevel( 1 );
