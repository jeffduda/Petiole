...
int itkGraphDensityCalculatorTest( int itkNotUsed(argc), char * itkNotUsed(argv) [] )
{
  ...
  std::cout << "Undirected: " << calc->GetDensity() << std::endl;
  calc->ComputeDirectedDensity();
  std::cout << "Directed: " << calc->GetDensity() << std::endl;
