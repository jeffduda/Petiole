/*=========================================================================
  ...
  Module:    $RCSfile: itkExtractRichClubGraphFilterTest.cxx,v $
  Language:  C++
  Date:      $Date: $
  Version:   $Revision: $
...
int itkExtractRichClubGraphFilterTest( int itkNotUsed(argc), char * itkNotUsed(argv) [] )
{
  ...
  typedef itk::ExtractRichClubGraphFilter<GraphType,GraphType> FilterType;
  ...
  unionleague->SetLevel( 2 );
  unionleague->SetIsWeighted(false);
  ...
  std::cout << "Rich club coefficient: " << unionleague->GetRichClubCoefficient() << std::endl;
