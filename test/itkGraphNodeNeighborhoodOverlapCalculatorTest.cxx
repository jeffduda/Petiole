...
int itkGraphNodeNeighborhoodOverlapCalculatorTest( int itkNotUsed(argc), char * itkNotUsed(argv) [] )
{
  ...
  typedef itk::GraphNodeNeighborhoodOverlapCalculator<GraphType>      CalculatorType;
  ...
  calc->ComputeIncomingNeighborhoodOverlap();
  std::cout << "Incoming Neighborhood Overlap" << std::endl << calc->GetNeighborhoodOverlap() << std::endl;

  calc->ComputeOutgoingNeighborhoodOverlap();
  std::cout << "Outgoing Neighborhood Overlap" << std::endl << calc->GetNeighborhoodOverlap() << std::endl;

  calc->ComputeUndirectedNeighborhoodOverlap();
  std::cout << "Undirected Neighborhood Overlap" << std::endl <<  calc->GetNeighborhoodOverlap() << std::endl;
