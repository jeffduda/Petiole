/*=========================================================================
  ...
  Module:    $RCSfile: itkDijkstrasDistanceMatrixGraphFilter.h,v $
  Language:  C++
  Date:
...
=========================================================================*/
#ifndef __itkDijkstrasDistanceMatrixGraphFilter_h
#define __itkDijkstrasDistanceMatrixGraphFilter_h
...
/** \class itkDijkstrasDistanceMatrixGraphFilter
...
class ITK_EXPORT DijkstrasDistanceMatrixGraphFilter
: public InPlaceGraphFilter<TGraph>
{
public:
  /** Standard "Self" typedef. */
  typedef DijkstrasDistanceMatrixGraphFilter   Self;
  ...
  itkTypeMacro( DijkstrasDistanceMatrixGraphFilter, InPlaceGraphFilter );
  ...
  itkGetMacro( DistanceMatrix, MatrixType );
  itkGetMacro( NStepMatrix, MatrixType );
  itkGetMacro( NodeEccentricity, VectorType );
  itkGetMacro( CharacteristicPathLength, ValueType );
  itkGetMacro( GlobalEfficiency, ValueType );
  itkGetMacro( Radius, ValueType );
  itkGetMacro( Diameter, ValueType );
...
private:
  DijkstrasDistanceMatrixGraphFilter( const Self& ); //purposely not implemented
  ...
  MatrixType m_NStepMatrix;

  NodeListContainerType m_Tree;

  ValueType m_CharacteristicPathLength;

  ValueType m_GlobalEfficiency;

  VectorType m_NodeEccentricity;

  ValueType m_Radius;

  ValueType m_Diameter;
...
#include "itkDijkstrasDistanceMatrixGraphFilter.hxx"
#endif
