 ...
 *
 *=========================================================================*/
#ifndef __itkExtractKCoreGraphFilter_h
#define __itkExtractKCoreGraphFilter_h
...
class ITK_EXPORT ExtractKCoreGraphFilter:public GraphToGraphFilter<TInputGraph,TOutputGraph>
{
public:
  /** Standard class typedefs. */
  typedef ExtractKCoreGraphFilter                             Self;
  ...
  itkTypeMacro(ExtractKCoreGraphFilter, Object);
...
protected:
  ...
  virtual ~ExtractKCoreGraphFilter() {}
  void PrintSelf(std::ostream & os, Indent indent) const;

private:
  ExtractKCoreGraphFilter(const Self &);           //purposely not implemented
...
#include "itkExtractKCoreGraphFilter.hxx"
#endif

#endif /* __itkExtractKCoreGraphFilter_h */
