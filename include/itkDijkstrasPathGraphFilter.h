/*=========================================================================
  ...
  Module:    $RCSfile: itkDijkstrasPathGraphFilter.h,v $
  Language:  C++
  Date:
...
=========================================================================*/
#ifndef __itkDijkstrasPathGraphFilter_h
#define __itkDijkstrasPathGraphFilter_h
...
public:
  ...
  itkTypeMacro( DijkstrasPathGraphFilter, InPlaceGraphFilter );
  ...
  typedef typename GraphType::RegionType                RegionType;
  typedef typename RegionType::Pointer                  RegionPointer;
  ...
  itkSetObjectMacro( TargetNodes, RegionType );
  itkGetObjectMacro( TargetNodes, RegionType );  
  itkSetObjectMacro( SourceNodes, RegionType );
  itkGetObjectMacro( SourceNodes, RegionType );
...
private:
  ...
  RegionPointer m_TargetNodes;

  RegionPointer m_SourceNodes;
...
#include "itkDijkstrasPathGraphFilter.hxx"
#endif
