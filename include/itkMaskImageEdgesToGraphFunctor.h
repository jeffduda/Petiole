/*=========================================================================
  ...
  Module:    $RCSfile: itkMaskImageEdgesToGraphFunctor.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkMaskImageEdgesToGraphFunctor_h
#define __itkMaskImageEdgesToGraphFunctor_h
...
class MaskImageEdgesToGraphFunctor : public ImageToGraphFunctor<TInputImage, TOutputGraph>
{
public:
  /** Standard class typedefs. */
  typedef MaskImageEdgesToGraphFunctor                   Self;
  ...
  itkTypeMacro(MaskImageEdgesToGraphFunctor, ImageToGraphFunctor);
...
protected:
  MaskImageEdgesToGraphFunctor() {}
  ~MaskImageEdgesToGraphFunctor() {}
  void PrintSelf(std::ostream& os, Indent indent) const
     { Superclass::PrintSelf( os, indent ); }

private:
  MaskImageEdgesToGraphFunctor(const Self&); //purposely not implemented
...
#include "itkMaskImageEdgesToGraphFunctor.hxx"
#endif
