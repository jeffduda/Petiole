 ...
 *
 *=========================================================================*/
#ifndef __itkDensityThresholdGraphFilter_h
#define __itkDensityThresholdGraphFilter_h
...
namespace itk
{
/** \class DensityThresholdGraphFilter
...
class ITK_EXPORT DensityThresholdGraphFilter:public GraphToGraphFilter<TInputGraph,TOutputGraph>
{
public:
  /** Standard class typedefs. */
  typedef DensityThresholdGraphFilter                             Self;
  ...
  itkTypeMacro(DensityThresholdGraphFilter, Object);
...
protected:
  ...
  virtual ~DensityThresholdGraphFilter() {}
  void PrintSelf(std::ostream & os, Indent indent) const;

private:
  DensityThresholdGraphFilter(const Self &);           //purposely not implemented
...
#include "itkDensityThresholdGraphFilter.hxx"
#endif

#endif /* __itkDensityThresholdGraphFilter_h */
