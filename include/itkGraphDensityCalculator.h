 ...
 *
 *=========================================================================*/
#ifndef __itkGraphDensityCalculator_h
#define __itkGraphDensityCalculator_h
 ...
 *
 * \wiki
 * \wikiexample{ImageProcessing/GraphDensityCalculator,Find the minimum and maximum value (and the position of the value) in an image}
...
class ITK_EXPORT GraphDensityCalculator:public Object
{
public:
  /** Standard class typedefs. */
  typedef GraphDensityCalculator Self;
  ...
  itkTypeMacro(GraphDensityCalculator, Object);
  ...
  void ComputeDirectedDensity(void);

  /** Compute the outward degree of the nodes in the graph. */
  void ComputeUndirectedDensity(void);

  ValueType GetDensity( void ) 
...
protected:
  ...
  virtual ~GraphDensityCalculator() {}
  void PrintSelf(std::ostream & os, Indent indent) const;

private:
  GraphDensityCalculator(const Self &); //purposely not implemented
...
#include "itkGraphDensityCalculator.hxx"
#endif

#endif /* __itkGraphDensityCalculator_h */
