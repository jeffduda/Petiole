 ...
 *
 *=========================================================================*/
#ifndef __itkGraphIntersectionGraphFilter_h
#define __itkGraphIntersectionGraphFilter_h
...
namespace itk
{
/** \class GraphIntersectionGraphFilter
...
class ITK_EXPORT GraphIntersectionGraphFilter:public GraphToGraphFilter<TInputGraph,TOutputGraph>
{
public:
  /** Standard class typedefs. */
  typedef GraphIntersectionGraphFilter                             Self;
  ...
  itkTypeMacro(GraphIntersectionGraphFilter, Object);
  ...
  itkGetMacro( Density, float );
  itkSetMacro( Density, float );

  itkGetMacro( Binarize, bool );
  itkSetMacro( Binarize, bool );

protected:
  GraphIntersectionGraphFilter();
  virtual ~GraphIntersectionGraphFilter() {}
  void PrintSelf(std::ostream & os, Indent indent) const;

private:
  GraphIntersectionGraphFilter(const Self &);           //purposely not implemented
  ...
  float        m_BinaryPearsonCorrelation;

};
} // end namespace itk

#ifndef ITK_MANUAL_INSTANTIATION
#include "itkGraphIntersectionGraphFilter.hxx"
#endif

#endif /* __itkGraphIntersectionGraphFilter_h */
