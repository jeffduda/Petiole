...
public:
  ...
  typedef typename GraphTraitsType::NodeIdentifierContainerType
  ...
  typedef VectorContainer<unsigned int, unsigned int> RegionType;


  /** Return the total number of nodes. */
  unsigned int GetTotalNumberOfNodes() const
    { return m_Nodes->Size(); }
  /** Return the total number of edges. */
  unsigned int GetTotalNumberOfEdges() const
    { return m_Edges->Size(); }
  ...
  /** Get Nodes/Edges         */
  NodeType& GetNode( NodeIdentifierType Id ) const
    { return m_Nodes->ElementAt( Id ); }
  EdgeType& GetEdge( EdgeIdentifierType Id ) const
  ...
  bool HasEdge( NodeIdentifierType, NodeIdentifierType ) const;
  bool NodesAreNeighbors( NodeIdentifierType i, NodeIdentifierType j ) const
  ...
  /** Get adjacent nodes */
  NodeIdentifierContainerType GetOutgoingNeighbors( NodeIdentifierType ) const;
  NodeIdentifierContainerType GetIncomingNeighbors( NodeIdentifierType ) const;
  NodeIdentifierContainerType GetAllNeighbors( NodeIdentifierType ) const;
  ...
  virtual void SetIncomingAndOutgoingEdges();
  ...
  class ConstNodeIterator
    {
    public:
    ConstNodeIterator( const Graph* graph )
      { this->m_Graph = graph; }
    ~ConstNodeIterator() {}
