 ...
 *
 *=========================================================================*/
#ifndef __itkExtractSCoreGraphFilter_h
#define __itkExtractSCoreGraphFilter_h
...
class ITK_EXPORT ExtractSCoreGraphFilter:public GraphToGraphFilter<TInputGraph,TOutputGraph>
{
public:
  /** Standard class typedefs. */
  typedef ExtractSCoreGraphFilter                             Self;
  ...
  itkTypeMacro(ExtractSCoreGraphFilter, Object);
  ...
  itkGetMacro( Level, ValueType );
  itkSetMacro( Level, ValueType );

protected:
  ExtractSCoreGraphFilter();
  virtual ~ExtractSCoreGraphFilter() {}
  void PrintSelf(std::ostream & os, Indent indent) const;

private:
  ExtractSCoreGraphFilter(const Self &);           //purposely not implemented
...
#include "itkExtractSCoreGraphFilter.hxx"
#endif

#endif /* __itkExtractSCoreGraphFilter_h */
