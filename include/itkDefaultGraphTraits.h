...
public:
  ...
  void CopyNodeStaticData( NodeType & input, NodePointerType & duplicate )
  {
    duplicate->Weight = input.Weight;      
  };
  
  void CopyEdgeStaticData( EdgeType & input, EdgePointerType & duplicate )
  {
    duplicate->Weight = input.Weight;      
  };
